...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-cinema-primary dark:bg-cinema-navy/30 text-cinema-navy dark:text-white py-6 px-4 relative overflow-hidden shadow-md backdrop-blur-sm">
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
            className="md:hidden absolute top-full left-0 right-0 bg-cinema-primary dark:bg-cinema-navy/90 backdrop-blur-md z-[100] shadow-lg"
          >
      ...
      <div className="absolute right-1/4 top-1/2 -translate-y-1/2 opacity-5 pointer-events-none">
        <Film className="h-32 w-32 text-cinema-gold" />
      </div>
    </header>
  );
